...
- **Public status page** → [Uptime Kuma]([https://quadstronaut.seedbox.example.com/status/public](https://uptimekuma-quadstronaut.seedbox.example.com/status/public)) — every monitor, no login.
