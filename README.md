...
<p>
  ...
  <a href="#operator-visibility"><img alt="Kuma" src="https://img.shields.io/badge/Kuma-50%2F50_up-d4af37?style=for-the-badge&labelColor=0a1628"></a>
...
| Kuma push monitors (manitoba-owned) | **50** | every manifest app + all 15 canaries + the daemon's self-heartbeat report continuously ("Qflix Quality Fallback" pending one-time operator bootstrap — see docs/operator-deferred.md). Plus 4 external (3 Quadstronix nodes + 1 workstation collector); external PUSH tokens self-heal across `bootstrap-kuma-monitors.py` runs as of 2026-05-22. |
...
```text
manifest/apps.yaml           # 34 apps + 15 canaries — single source of truth
