...
<p>
  ...
  <a href="#operator-visibility"><img alt="Kuma" src="https://img.shields.io/badge/Kuma-82%2F82_up-d4af37?style=for-the-badge&labelColor=0a1628"></a>
...
```text
manifest/apps.yaml           # 31 apps + 39 canaries — single source of truth
...
apps/
  ...
  canaries/                  # 39 end-to-end pipeline checks (bash)
  ...
  maint/                     # the maintenance daemon
    ...
    systemd/                 # 60 services + 60 timers LIVE in ~/.config/systemd/user/
